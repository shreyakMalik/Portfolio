        ...
        >
                    ...
                    {({ inView, ref }) => (
                        ...
                        >
                            <h1 className="Welcome-text text-[16px] w-full text-justify">
                                As a passionate Full Stack Developer with expertise in React,
                                TypeScript, REST APIs, Node.js, HTML, and CSS, 
                                I craft seamless digital experiences.
                                I focus on building efficient, scalable, and user-friendly web applications,
                                working across both front-end and back-end technologies. I enjoy writing clean,
                                maintainable code and continuously learning to deliver real-world solutions.
            ...
            <div className="absolute z-[20] bottom-[-4rem] md:bottom-[10px] px-[5px]">
                <div className="cursive text-[20px] font-medium text-center text-gray-300">
                    From database to browser, ɪ build it all
                </div>
            </div>

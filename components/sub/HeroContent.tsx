                    ...
                    <div className="h-full w-full md:w-3/6 flex flex-col gap-5 justify-center text-start">
                        ...
                        <InView triggerOnce={false}>
                            {({ inView, ref }) => (
                                ...
                                >
                                    <li>
                                        I like to code and build web applications
                                    </li>
                                    <li>
                                        I enjoy solving problems and learning new technologies
                                    </li>
                                    <li>
                                        I love playing games and exploring game mechanics
                                    </li>
                                    <li>
                                        Gaming helps me think logically and creatively
                                    </li>
                                    <li>
                                        I apply the same focus and strategy from games to my coding projects
                                    </li>
                                </motion.div>
                            )}
                        </InView>
